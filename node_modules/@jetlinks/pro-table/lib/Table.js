...
var _proUtils = require("@jetlinks/pro-utils");
...
var _encodeQuery = _interopRequireDefault(require("./utils/encodeQuery"));

var _lodash = _interopRequireDefault(require("lodash"));

var _excluded = ["rowKey", "tableClassName", "action", "tableColumn", "type", "pagination", "rowSelection", "size", "tableStyle", "toolbarDom", "searchNode", "style", "cardProps", "alertDom", "onSortChange", "onFilterChange", "options", "isLightFilter", "className", "cardBordered", "editableUtils", "rootRef"],
    _excluded2 = ["cardBordered", "request", "className", "params", "defaultData", "headerTitle", "postData", "pagination", "actionRef", "columns", "toolBarRender", "onLoad", "onRequestError", "style", "cardProps", "tableStyle", "tableClassName", "columnsStateMap", "onColumnsStateChange", "options", "search", "onLoadingChange", "rowSelection", "beforeSearchSubmit", "tableAlertRender", "defaultClassName", "formRef", "type", "columnEmptyText", "toolbar", "rowKey", "manualRequest", "polling", "tooltip", "defaultParams"];
  ...
  var fetchData = (0, _react.useMemo)(function () {
    ...
    return /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(pageParams) {
        var _actionParams$terms;

        var filterK, filter, actionParams, response;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                filterK = _lodash.default.mapKeys(proFilter, function (v, k) {
                  return "".concat(k, "$IN");
                });
                filter = _lodash.default.omitBy(filterK, _lodash.default.isNull); // 格式化排序参数，ant design table的排序值为descend /ascend
                // const sorts = _.mapValues(proSort,v=>v!==null&&v.replace("end",""));

                actionParams = _objectSpread(_objectSpread({}, pageParams || {}), {}, {
                  terms: _objectSpread(_objectSpread(_objectSpread({}, filter), formSearch), defaultParams),
                  sorts: proSort
                }, params); // eslint-disable-next-line no-underscore-dangle

                actionParams === null || actionParams === void 0 ? true : (_actionParams$terms = actionParams.terms) === null || _actionParams$terms === void 0 ? true : delete _actionParams$terms._timestamp;
                _context.next = 6;
                return request((0, _encodeQuery.default)(actionParams), proSort, proFilter);
