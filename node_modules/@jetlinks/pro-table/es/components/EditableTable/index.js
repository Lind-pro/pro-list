...
var _excluded = ["onTableChange", "maxLength", "recordCreatorProps", "rowKey", "controlled"],
    _excluded2 = ["record", "position", "creatorButtonText", "newRecordType"];
...
import { runFunction } from '@jetlinks/pro-utils';
...
function EditableTable(props) {
  ...
  return /*#__PURE__*/React.createElement(EditableTableActionContext.Provider, {
    ...
    dataSource: value,
    editable: _objectSpread(_objectSpread({
      form: form
    }, props.editable), {}, {
      onValuesChange: (props === null || props === void 0 ? void 0 : props.onValuesChange) || ((_props$editable = props.editable) === null || _props$editable === void 0 ? void 0 : _props$editable.onValuesChange) || // 受控模式需要触发 onchange
      props.controlled && (props === null || props === void 0 ? void 0 : props.onChange) ? function (r, dataSource) {
