...
import { usePrevious, useDebounceFn, useDeepCompareEffect, useMountMergeState, runFunction } from '@jetlinks/pro-utils';
...
var useFetchData = function useFetchData(getData, defaultData, options) {
  ...
  var fetchList = /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(isPolling) {
      var _ref5, pageSize, current, pageParams, _ref6, status, _ref6$result, _ref6$result$data, data, _ref6$result$total, total, rest, responseData;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 15:
              ...
              _ref6$result$data = _ref6$result.data;
              data = _ref6$result$data === void 0 ? [] : _ref6$result$data;
              _ref6$result$total = _ref6$result.total;
              total = _ref6$result$total === void 0 ? 0 : _ref6$result$total;
