...
import { useDeepCompareEffect, omitUndefined, useMountMergeState, useEditableArray, ErrorBoundary } from '@jetlinks/pro-utils';
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                filterK = _.mapKeys(proFilter, function (v, k) {
                  return "".concat(k, "$IN");
                });
                filter = _.omitBy(filterK, _.isNull); // 格式化排序参数，ant design table的排序值为descend /ascend
                ...
                _context.next = 6;
                return request(encodeQuery(actionParams), proSort, proFilter);
