...
function ListView(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_antd.List, _extends({}, rest, {
    dataSource: pageData,
    ...
    renderItem: function renderItem(item, index) {
      ...
      columns === null || columns === void 0 ? void 0 : columns.forEach(function (column) {
        _constants.PRO_LIST_KEYS.forEach(function (key) {
          if (column.listKey === key) {
            ...
            var rawData = Array.isArray(dataIndex) ? (0, _get.default)(item, dataIndex) : item[dataIndex]; // 渲染数据
      ...
      var defaultDom = /*#__PURE__*/_react.default.createElement(_Item.default, _extends({
        key: recordKey,
        cardProps: rest.grid
      }, listItemProps, {
        recordKey: recordKey,
