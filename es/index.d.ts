...
import type { ProTableProps, ProColumnType } from '@jetlinks/pro-table';
import type { ParamsType } from '@ant-design/pro-provider';
import type { LabelTooltipType } from 'antd/lib/form/FormItemLabel';
import './index.less';
import type { ItemProps } from './Item';
declare type AntdListProps<RecordType> = Omit<ListProps<RecordType>, 'rowKey'>;
declare type ProListMeta<T> = Pick<ProColumnType<T>, 'dataIndex' | 'valueType' | 'render' | 'search' | 'title' | 'valueEnum' | 'editable'>;
...
export declare type ProListProps<RecordType, U extends ParamsType> = Omit<ProTableProps<RecordType, U>, 'size' | 'footer'> & AntdListProps<RecordType> & {
